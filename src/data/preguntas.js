export const preguntas = [
    {
        ...
        explicacion:
            "Lo correcto es agacharse, cubrirse la cabeza y alejarse de ventanas y objetos que puedan caer.",
    },
    {
        id: 2,
        ...
        explicacion:
            "El retiro repentino del mar es una señal de tsunami. Debes alejarte de la costa y subir a un lugar alto de inmediato.",
    },
    {
        id: 3,
        categoria: "Inundaciones",
        pregunta:
            "Si vives cerca de una quebrada y llueve torrencialmente por más de 45 minutos, ¿qué debes verificar?",
        opciones: [
        ...
        explicacion:
            "Debes monitorear el nivel del agua en la quebrada y estar preparado para evacuar si es necesario.",
    },
    {
        id: 4,
        ...
        explicacion:
            "Un plan familiar completo debe incluir un punto de encuentro designado y una mochila de emergencia para 72 horas.",
    },
];

export const nivelesResultado = [
    {
        rango: [0, 40],
        nivel: "critico",
